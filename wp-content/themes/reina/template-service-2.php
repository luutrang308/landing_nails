 ...
 */
get_header();
$request = wp_remote_get('https://server-fupca5ldna-uc.a.run.app/api/shop-services?locationCode=7662');
if (!empty($request)) {
...
<div id="list_product_category" class="list_product_category">
    ...
    <div class="element_list_pro">
        <nav>
            <div class="container">
                <ul>
                    <?php if (isset($categoies) && count($categoies)) : $index = 0; ?>
                        <?php foreach ($categoies as $category) : ?>
                            <li class="phela<?= $index ?>">
                                <a class="nav-link" href="#phela<?= $index ?>"><?= $category->categoryName ?></a>
                            </li>
                        <?php $index++;
                        endforeach ?>
                    <?php endif ?>
            ...
            ?>
                    ...
                    ?>
                        <div class="product-item">
                            ...
                            <img src="<?= wp_get_attachment_image_url($product->get_image_id(), array(238, 200)) ?>" alt="<?= $product->get_name() ?>">
                             </a>
                            </div> -->
                            <div class="content">
                                <div class="title-pro">
