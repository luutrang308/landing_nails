...
class WP_Import extends WP_Importer {
	...
	function handle_upload() {
		...
		if ( isset( $file['error'] ) ) {
			...
			echo '<p><strong>' . esc_html__( 'Sorry, there has been an error.', 'wordpress-importer' ) . '</strong><br />';
			printf( wp_kses(__( 'The export file could not be found at <code>%s</code>. It is likely that this was caused by a permissions problem.', 'wordpress-importer' ), array("code" => array())), esc_html( $file['file'] ) );
			echo '</p>';
			return false;
		}
