...
class MinimalMobileHeader extends ReinaCoreMobileHeader {
	...
	public function __construct() {
		...
		add_action( 'reina_core_filter_available_mobile_header_logo_images', array( $this, 'set_logo_image' ) );
	...
	function fullscreen_menu_template() {
		$header = reina_core_get_post_value_through_levels( 'qodef_header_layout' );
