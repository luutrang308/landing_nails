...
if ( ! function_exists( 'reina_core_dependency_for_mobile_menu_typography_options' ) ) {
	/**
	 * Function that set dependency values for module global options
	 *
	 * @return array
	 */
	function reina_core_dependency_for_mobile_menu_typography_options() {
		return apply_filters( 'reina_core_filter_mobile_menu_typography_hide_option', $hide_dep_options = array() );
	}
}

if ( ! function_exists( 'reina_core_set_mobile_header_styles' ) ) {
	/**
	 ...
	 * @return string
	 */
	function reina_core_set_mobile_header_styles( $style ) {
		$opener_styles    = array();
		$opener_color     = reina_core_get_post_value_through_levels( 'qodef_mobile_header_opener_color' );
		$opener_icon_size = reina_core_get_post_value_through_levels( 'qodef_mobile_header_opener_size' );
		...
		$opener_hover_color  = reina_core_get_post_value_through_levels( 'qodef_mobile_header_opener_hover_color' );
	...
	add_filter( 'reina_theme_filter_add_inline_style', 'reina_core_set_mobile_header_styles' );
}
