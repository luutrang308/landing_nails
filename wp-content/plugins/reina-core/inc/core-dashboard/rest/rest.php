...
if ( ! class_exists( 'ReinaCoreDashboardRestAPI' ) ) {
	 ...
	 */
	class ReinaCoreDashboardRestAPI {
		...
		public function __construct() {
			...
			add_filter( 'reina_core_filter_dashboard_js_global_variables', array( $this, 'localize_script' ) );
	...
	ReinaCoreDashboardRestAPI::get_instance();
}