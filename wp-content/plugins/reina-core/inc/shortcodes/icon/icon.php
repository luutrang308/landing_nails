...
if ( ! function_exists( 'reina_core_add_icon_shortcode' ) ) {
	/**
	 ...
	 * @return array
	 */
	function reina_core_add_icon_shortcode( $shortcodes ) {
		$shortcodes[] = 'ReinaCoreIconShortcode';
		
		return $shortcodes;
	}
	
	add_filter( 'reina_core_filter_register_shortcodes', 'reina_core_add_icon_shortcode', 8 );
}

if ( class_exists( 'ReinaCoreShortcode' ) ) {
	class ReinaCoreIconShortcode extends ReinaCoreShortcode {
		
		public function map_shortcode() {
			$this->set_shortcode_path( REINA_CORE_SHORTCODES_URL_PATH . '/icon' );
			$this->set_base( 'reina_core_icon' );
			$this->set_name( esc_html__( 'Icon', 'reina-core' ) );
			$this->set_description( esc_html__( 'Shortcode that adds icon element', 'reina-core' ) );
			...
			$this->set_option( array(
				'field_type'	=> 'iconpack',
				'name'			=> 'main_icon',
				'title'			=> esc_html__( 'Icon', 'reina-core' ),
			) );
			$this->set_option( array(
				'field_type' => 'select',
				'name'       => 'size',
				...
				'options'    => array(
					...
					'tiny'    => esc_html__( 'Tiny', 'reina-core' ),
					'small'   => esc_html__( 'Small', 'reina-core' ),
					'medium'  => esc_html__( 'Medium', 'reina-core' ),
					'large'   => esc_html__( 'Large', 'reina-core' ),
					'huge'    => esc_html__( 'Huge', 'reina-core' ),
				)
			) );
			$this->set_option( array(
				'field_type' => 'text',
				'name'       => 'custom_size',
				'title'      => esc_html__( 'Custom Size', 'reina-core' ),
			) );
			$this->set_option( array(
				'field_type'    => 'select',
				'name'          => 'icon_layout',
			...
			$this->set_option( array(
				'field_type' => 'text',
				'name'       => 'border_radius',
				'title'      => esc_html__( 'Border Radius', 'reina-core' ),
				'dependency' => array(
					'show' => array(
						'icon_layout' => array(
							'values'        => 'square',
			...
			$this->set_option( array(
				'field_type' => 'text',
				'name'       => 'shape_size',
				'title'      => esc_html__( 'Shape Size', 'reina-core' ),
				'dependency' => array(
					'show' => array(
						'icon_layout' => array(
			...
			$this->set_option( array(
				'field_type' => 'text',
				'name'       => 'border_width',
				'title'      => esc_html__( 'Border Width', 'reina-core' ),
				'dependency' => array(
					'show' => array(
						'icon_layout' => array(
							'values'        => array( 'circle', 'square' ),
			...
			$this->set_option( array(
				...
				'title'      => esc_html__( 'Border Hover Color', 'reina-core' ),
				'dependency' => array(
					'show' => array(
						'icon_layout' => array(
							'values'        => array( 'circle', 'square' ),
            ...
            $this->set_option( array(
                ...
                'title'      => esc_html__( 'Vertical Offset', 'reina-core' ),
            ) );
			$this->set_option( array(
				'field_type' => 'text',
				'name'       => 'margin',
			...
			$this->set_option( array(
				'field_type' => 'text',
				'name'       => 'link',
				'title'      => esc_html__( 'Icon Link', 'reina-core' )
			) );
			$this->set_option( array(
				'field_type'    => 'select',
				'name'          => 'target',
		...
		public static function call_shortcode( $params ) {
			$html = qode_framework_call_shortcode( 'reina_core_icon', $params );
			$html = str_replace( "\n", '', $html );
		...
		public function render( $options, $content = null ) {
			...
			return reina_core_get_template_part( 'shortcodes/icon', 'templates/icon', '', $atts );
		}
