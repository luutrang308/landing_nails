<div <?php qode_framework_class_attribute( $holder_classes ); ?>>
	<div class="qodef-m-inner clear" <?php echo qode_framework_inline_style( $info_background_styles ); ?>>
		<?php reina_core_template_part( 'shortcodes/image-section-info', 'templates/parts/image', '', $params ); ?>
		<div class="qodef-m-content">
			<?php reina_core_template_part( 'shortcodes/image-section-info', 'templates/parts/image-above-title', '', $params ) ?>
