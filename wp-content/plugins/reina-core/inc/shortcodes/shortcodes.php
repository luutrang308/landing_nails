...
if ( ! class_exists( 'ReinaCoreShortcodes' ) ) {
	class ReinaCoreShortcodes {
		...
		function init() {
			...
			include_once REINA_CORE_SHORTCODES_PATH . '/dashboard/customizer/shortcodes-customizer-options.php';
		}
		...
		function include_shortcode_classes() {
			include_once REINA_CORE_SHORTCODES_PATH . '/shortcode.php';
			include_once REINA_CORE_SHORTCODES_PATH . '/list-shortcode.php';
		}
		...
		function register_shortcodes() {
			...
			$shortcodes     = apply_filters( 'reina_core_filter_register_shortcodes', $shortcodes = array() );
	...
	ReinaCoreShortcodes::get_instance();
}