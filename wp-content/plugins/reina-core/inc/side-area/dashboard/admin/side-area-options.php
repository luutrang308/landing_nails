...
if ( ! function_exists( 'reina_core_side_area_options' ) ) {
	/**
	 * Function that add global module options
	 */
	function reina_core_side_area_options() {
		...
		$page = $qode_framework->add_options_page(
			array(
				...
				'slug'        => 'sidearea',
				'icon'        => 'fa fa-indent',
				'title'       => esc_html__( 'Side Area', 'reina-core' ),
				'description' => esc_html__( 'Global Side Area Options', 'reina-core' )
			)
		);
		...
		if ( $page ) {
			$page->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Side Area Width', 'reina-core' ),
					'description' => esc_html__( 'Enter a width for Side Area (px or %).', 'reina-core' )
				)
			);
			...
			$page->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Content Overlay Background Color', 'reina-core' ),
					'description' => esc_html__( 'Choose a background color for a content overlay', 'reina-core' )
				)
			);
			...
			$page->add_field_element(
				array(
					...
					'description' => esc_html__( 'Choose a background color for side area', 'reina-core' )
				)
			);
			...
			$page->add_field_element(
				array(
					'field_type' => 'textarea',
					'name'       => 'qodef_side_area_svg',
					'title'      => esc_html__( 'Side Area SVG', 'reina-core' ),
			...
			$page->add_field_element(
				array(
					'field_type'  => 'color',
					'name'        => 'qodef_side_area_svg_stroke',
			...
			$page->add_field_element(
				array(
					...
					'title'         => esc_html__( 'Icon Source', 'reina-core' ),
					'default_value' => 'icon_pack',
					'options'       => reina_core_get_select_type_options_pool( 'icon_source', false )
				)
			);
			...
			$section_svg_path->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Side Area Open Icon SVG Path', 'reina-core' ),
					'description' => esc_html__( 'Enter your side area open icon SVG path here. Please remove version and id attributes from your SVG path because of HTML validation', 'reina-core' )
				)
			);
			...
			$section_svg_path->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Side Area Close Icon SVG Path', 'reina-core' ),
					'description' => esc_html__( 'Enter your side area close icon SVG path here. Please remove version and id attributes from your SVG path because of HTML validation', 'reina-core' ),
				)
			);
			...
			$color_section = $page->add_section_element(
				array(
					...
					'title' => esc_html__( 'Colors', 'reina-core' )
				)
			);
			...
			$color_section->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Close Icon Color', 'reina-core' )
				)
			);
			...
			$color_section->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Close Icon Hover Color', 'reina-core' )
				)
			);
			...
			$page->add_field_element(
				array(
					...
					'description' => esc_html__( 'Choose text alignment for side area', 'reina-core' ),
					'options'     => array(
			...
			do_action( 'reina_core_action_after_side_area_options_map', $page );
		}
	}

	add_action( 'reina_core_action_default_options_init', 'reina_core_side_area_options', reina_core_get_admin_options_map_position( 'side-area' ) );
}
