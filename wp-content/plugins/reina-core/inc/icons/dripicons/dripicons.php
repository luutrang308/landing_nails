...
if ( ! function_exists( 'reina_core_add_dripicons_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function reina_core_add_dripicons_to_collection( $icons ) {
		$icons[] = 'ReinaCoreDripiconsIconPack';
		
		return $icons;
	}

	add_filter( 'qode_framework_filter_add_icon', 'reina_core_add_dripicons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class ReinaCoreDripiconsIconPack extends QodeFrameworkIconPack {
