...
if ( ! function_exists( 'reina_core_add_linea_icons_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function reina_core_add_linea_icons_to_collection( $icons) {
		$icons[] = 'ReinaCoreLineaIconsPack';
		
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'reina_core_add_linea_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class ReinaCoreLineaIconsPack extends QodeFrameworkIconPack {
		...
		function specific_icons() {
			return array(
				...
				'dropdown-cart' => 'icon-ecommerce-bag'
			);
		}
	}
}