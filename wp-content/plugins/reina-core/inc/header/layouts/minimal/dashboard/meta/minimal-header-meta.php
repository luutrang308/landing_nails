...
if ( ! function_exists( 'reina_core_add_minimal_header_meta' ) ) {
	/**
	 * Function that add additional header layout meta box options
	 *
	 * @param object $page
	 */
	function reina_core_add_minimal_header_meta( $page ) {
	...
	add_action( 'reina_core_action_after_page_header_meta_map', 'reina_core_add_minimal_header_meta' );
}