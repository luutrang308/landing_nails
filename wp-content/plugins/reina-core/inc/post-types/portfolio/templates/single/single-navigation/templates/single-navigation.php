<?php
$is_enabled = reina_core_get_post_value_through_levels( 'qodef_portfolio_enable_navigation' );

if ( $is_enabled === 'yes' ) {
	$through_same_category = reina_core_get_post_value_through_levels( 'qodef_portfolio_navigation_through_same_category' ) === 'yes';
	?>
	<div id="qodef-single-portfolio-navigation" class="qodef-m">
		<div class="qodef-m-inner">
			...
			$post_navigation = array(
				'prev'      => array(
					'label' => '<span class="qodef-m-nav-label">' . esc_html__( 'Previous', 'reina-core' ) . '</span>',
					'icon'  => qode_framework_icons()->render_icon( 'arrow_carrot-left', 'elegant-icons', array( 'icon_attributes' => array( 'class' => 'qodef-m-nav-icon' ) ) )
				),
				'back-link' => array(),
				'next'      => array(
					'label' => '<span class="qodef-m-nav-label">' . esc_html__( 'Next', 'reina-core' ) . '</span>',
					'icon'  => qode_framework_icons()->render_icon( 'arrow_carrot-right', 'elegant-icons', array( 'icon_attributes' => array( 'class' => 'qodef-m-nav-icon' ) ) )
				)
			);
			...
			if ( $back_to_link !== '' ) {
				$post_navigation['back-link'] = array(
					...
					'icon'    => qode_framework_icons()->render_icon( 'icon_menu', 'elegant-icons', array( 'icon_attributes' => array( 'class' => 'qodef-m-nav-icon' ) ) )
				);
			}
