...
if ( ! class_exists( 'ReinaCoreWooCommerceYITHWishlist' ) ) {
	class ReinaCoreWooCommerceYITHWishlist {
		...
		function change_templates_position() {
			...
			add_action( 'reina_action_product_list_item_additional_image_content', 'reina_core_get_yith_wishlist_shortcode' );
			add_action( 'reina_core_action_product_list_item_additional_image_content', 'reina_core_get_yith_wishlist_shortcode' );
		}
	}
	
	ReinaCoreWooCommerceYITHWishlist::get_instance();
}